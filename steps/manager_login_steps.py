...
@Given(u'The manager is on the manager home page waiting to view pending requests')
def step_impl(context):
    context.driver.get("file:///C:/Users/track/OneDrive/Desktop/Revature/ExpenseReimbursementSystem/web_app/HTML"
                       "/manager_page.html")


@Then(u'The manager should be able to view pending reimbursement requests')
def step_impl(context):
    context.RRLoginPage.get_pending_rr_requests()


@Given(u'The manager is on the manager home page waiting to view completed requests')
def step_impl(context):
    context.driver.get("file:///C:/Users/track/OneDrive/Desktop/Revature/ExpenseReimbursementSystem/web_app/HTML"
                       "/manager_page.html")


@Then(u'The manager should be able to view completed reimbursement requests')
def step_impl(context):
    context.RRLoginPage.get_completed_rr_requests()

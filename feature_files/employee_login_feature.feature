Feature: The website should be able to login an employee
  ...
  Scenario: As an Employee I should be able to login
    ...
    When Employee inputs <employee id> into employee Id field
    When Employee inputs <first name> into first name field
    When Employee inputs <last name> into last name field
